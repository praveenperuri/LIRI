...
inquirer.prompt([
    ...
    // }, 
    {
        type: "list",
        name: "requestWhat",
        message: "HI !! What's your request??",
        choices: ["Search a movie?", "Search in Twitter?", "Search in Spotify?", "Get geocode of a location?", "Get weather of a location?"]
    }
]).then(function(user) {
    switch (user.requestWhat) {
        ...
        case "Get geocode of a location?":
            getGeocodeRequest();
            break;
        case "Get weather of a location?":
            getWeatherRequest();
            break;
        default:
